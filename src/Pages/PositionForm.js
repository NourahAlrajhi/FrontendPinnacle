        ...
        customUI: ({ onClose }) => {
          return (
            ...
            <div className='custom-ui' style={{ width: "max(148px, 110%)", background: "#333333", boxShadow: "0px 0px 8px lightgray", borderRadius: "8px", padding: "2%" }}>
              ...
              <p style={{ padding: "1.5rem 0", textAlign: "center", fontWeight: "600", color: "white" }}><VscWarning size={35} style={{ color: "#7024C4", margin: "-13px" }} /> &nbsp; You Have Reached The Maximum Number Of Questions</p>
            </div>
          )
        }
        // ----//change ui---
      ...
      customUI: ({ onClose }) => {
        return (
          ...
          <div className='custom-ui' style={{ width: "max(148px, 110%)", background: "#333333", boxShadow: "0px 0px 8px lightgray", borderRadius: "8px", padding: "2%" }}>
            ...
            <p style={{ padding: "1.5rem 0", textAlign: "center", fontWeight: "600", color: "white" }}><BsCheck2 size={35} style={{ color: "#A1E3CB", margin: "-13px" }} /> &nbsp; Position Added Successfully</p>
          </div>
        )
      }
      // ----//change ui---
